...
This app uses react, redux and Rails API to randomly display a greeting
And was created using Create REact APp
...
```
git clone  <https://github.com/NabilHY/hello-react-frontend.git>
```
